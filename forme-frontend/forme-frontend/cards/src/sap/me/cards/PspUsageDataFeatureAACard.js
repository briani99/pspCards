sap.ui.define([
    ...
    var PspUsageDataFeatureAACard = XMLComposite.extend("sap.me.cards.PspUsageDataFeatureAACard", {
        metadata: {
            properties: {
    ...
    PspUsageDataFeatureAACard.prototype.init = function() {
    ...
    PspUsageDataFeatureAACard.prototype.applySettings = function() {
    ...
    return PspUsageDataFeatureAACard;
}, /* bExport= */true);
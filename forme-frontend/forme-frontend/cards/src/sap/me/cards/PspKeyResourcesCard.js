sap.ui.define([
    ...
    var PspKeyResourcesCard = XMLComposite.extend("sap.me.cards.PspKeyResourcesCard", {
        metadata: {
            properties: {
    ...
    PspKeyResourcesCard.prototype.init = function() {
    ...
    PspKeyResourcesCard.prototype.applySettings = function() {

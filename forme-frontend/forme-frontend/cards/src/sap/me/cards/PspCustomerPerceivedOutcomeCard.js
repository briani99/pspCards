sap.ui.define([
    ...
    var PspCustomerPerceivedOutcomeCard = XMLComposite.extend("sap.me.cards.PspCustomerPerceivedOutcomeCard", {
        metadata: {
            properties: {
    ...
    PspCustomerPerceivedOutcomeCard.prototype.init = function() {
    ...
    PspCustomerPerceivedOutcomeCard.prototype.applySettings = function() {
    ...
    return PspCustomerPerceivedOutcomeCard;
}, /* bExport= */true);
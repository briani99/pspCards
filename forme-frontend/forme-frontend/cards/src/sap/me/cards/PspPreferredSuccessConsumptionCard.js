sap.ui.define([
    ...
    var PspPreferredSuccessConsumptionCard = XMLComposite.extend("sap.me.cards.PspPreferredSuccessConsumptionCard", {
        metadata: {
            properties: {
    ...
    PspPreferredSuccessConsumptionCard.prototype.init = function() {
    ...
    PspPreferredSuccessConsumptionCard.prototype.applySettings = function() {
    ...
    return PspPreferredSuccessConsumptionCard;
}, /* bExport= */true);
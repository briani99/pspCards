sap.ui.define([
    ...
    var PspServicesDeliveredCard = XMLComposite.extend("sap.me.cards.PspServicesDeliveredCard", {
        metadata: {
            properties: {
    ...
    PspServicesDeliveredCard.prototype.init = function() {
    ...
    PspServicesDeliveredCard.prototype.applySettings = function() {
    ...
    return PspServicesDeliveredCard;
}, /* bExport= */true);
sap.ui.define([
    ...
    var PspUsageDataFeatureRCard = XMLComposite.extend("sap.me.cards.PspUsageDataFeatureRCard", {
        metadata: {
            properties: {
    ...
    PspUsageDataFeatureRCard.prototype.init = function() {
    ...
    PspUsageDataFeatureRCard.prototype.applySettings = function() {
    ...
    return PspUsageDataFeatureRCard;
}, /* bExport= */true);
sap.ui.define([
    ...
    var PspSuccessFactorsOnboardingCard = XMLComposite.extend("sap.me.cards.PspSuccessFactorsOnboardingCard", {
        metadata: {
            properties: {
    ...
    PspSuccessFactorsOnboardingCard.prototype.init = function() {
    ...
    PspSuccessFactorsOnboardingCard.prototype.applySettings = function() {
    ...
    PspSuccessFactorsOnboardingCard.prototype.formatDate = function (sDate) {
    ...
    return PspSuccessFactorsOnboardingCard;
}, /* bExport= */true);
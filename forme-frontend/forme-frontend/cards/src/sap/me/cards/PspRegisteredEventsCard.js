sap.ui.define([
    ...
    var PspRegisteredEventsCard = XMLComposite.extend("sap.me.cards.PspRegisteredEventsCard", {
        metadata: {
            properties: {
    ...
    PspRegisteredEventsCard.prototype.init = function() {
    ...
    PspRegisteredEventsCard.prototype.applySettings = function() {
    ...
    PspRegisteredEventsCard.prototype.formatDate = function (sDate) {
    ...
    return PspRegisteredEventsCard;
}, /* bExport= */true);
sap.ui.define([
    ...
    var PspPreferredSuccessCard = XMLComposite.extend("sap.me.cards.PspPreferredSuccessCard", {
        metadata: {
            properties: {
    ...
    PspPreferredSuccessCard.prototype.init = function() {
    ...
    PspPreferredSuccessCard.prototype.applySettings = function() {
    ...
    return PspPreferredSuccessCard;
}, /* bExport= */true);
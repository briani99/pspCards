sap.ui.define([
    ...
    var PspAdoptionPlanExecutionCard = XMLComposite.extend("sap.me.cards.PspAdoptionPlanExecutionCard", {
        metadata: {
            properties: {
    ...
    PspAdoptionPlanExecutionCard.prototype.init = function() {
    ...
    PspAdoptionPlanExecutionCard.prototype._getI18n = function() {
        if (!this.i18n) {
    ...
    PspAdoptionPlanExecutionCard.prototype.applySettings = function() {
    ...
    return PspAdoptionPlanExecutionCard;
}, /* bExport= */true);
sap.ui.define([
    ...
    var PspNewLearningsSuccessFactorsOnboardingCard = XMLComposite.extend("sap.me.cards.PspNewLearningsSuccessFactorsOnboardingCard", {
        metadata: {
            properties: {
    ...
    PspNewLearningsSuccessFactorsOnboardingCard.prototype.init = function () {
    ...
    PspNewLearningsSuccessFactorsOnboardingCard.prototype.applySettings = function () {
    ...
    PspNewLearningsSuccessFactorsOnboardingCard.prototype.formatLastUpdated = function (sDate) {
    ...
    return PspNewLearningsSuccessFactorsOnboardingCard;
}, /* bExport= */true);